        ...
        <section className="about__wrap">
          ...
          <div className="about__grid">
            ...
            <article className="about__card">
              ...
              <div className="about__pillrow" role="list" aria-label="Focus areas">
                <span className="about__pill" role="listitem">Weddings</span>
                <span className="about__pill" role="listitem">Events</span>
                <span className="about__pill" role="listitem">Portraits</span>
              </div>

              <blockquote className="about__pull">“Let’s make magic together.”</blockquote>

              <div className="about__cta">
                <Link className="about__btn" to="/contact" aria-label="Go to contact page">
